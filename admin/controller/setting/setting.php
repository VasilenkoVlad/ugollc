...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['return_statuses'] = $this->model_localisation_return_status->getReturnStatuses();
                ...
                if (isset($this->request->post['config_send_sms_status'])) {
			$data['config_send_sms_status'] = $this->request->post['config_send_sms_status'];
		} elseif ($this->config->has('config_send_sms_status')) {
			$data['config_send_sms_status'] = $this->config->get('config_send_sms_status');
		} else {
