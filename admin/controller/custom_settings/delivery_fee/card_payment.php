<?php
class ControllerCustomSettingsDeliveryFeeCardPayment extends Controller {
	private $error = array();
	...
	public function index() {
		...
		$this->document->setTitle($this->language->get('card_payment_heading_title'));
	...
	protected function getList(){
		...
		$count_cod_fee_total = $this->model_custom_settings_delivery_fee->getTotalCardPaymentFees();
		...
		$range_delivey_fee_list = $this->model_custom_settings_delivery_fee->getRangeFee(2);
		...
		$data['heading_title'] = $this->language->get('card_payment_heading_title');
		...
		$this->response->setOutput($this->load->view('custom_settings/delivery_fee/card_payment/card_payment_fee_list.tpl', $data));
	}
	...
	protected function getDetailForm() {
		...
		$data['column_left'] = $this->load->controller('common/column_left');
		$data['footer'] = $this->load->controller('common/footer');
		$this->response->setOutput($this->load->view('custom_settings/delivery_fee/card_payment/card_payment_fee_detail.tpl', $data));
	}
	...
	protected function validateForm() {
		...
		$this->document->setTitle($this->language->get('card_payment_detail_heading_title'));
