    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
          ...
          <table class="table table-bordered">
            <thead>
              <tr>
                ...
                <td class="text-right"><?php echo $column_date_credit; ?></td>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-right"><?php echo $customer['date_credit']; ?></td>
        ...
        <div class="row">
          ...
          <div class="col-sm-7 text-right"><?php echo $results; ?></div>
        </div>
      </div>
    </div>
  </div>
...
$('#button-filter').on('click', function() {
  url = 'index.php?route=report/customer_buy_credit&token=<?php echo $token; ?>';
