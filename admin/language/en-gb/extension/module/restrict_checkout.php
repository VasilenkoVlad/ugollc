...
$_['help_restrictions']					= 'By default, checkout is always available. If all of the rules for a restriction are met, checkout will be disabled.';
...
$_['help_restriction_checkout_message']	= 'Enter the error message displayed when the restriction rules are not met. This will appear on the cart page, and the customer will not be able to proceed to the checkout until the rules are met.';
