...
class Onfleetlib {
    ...
    public function __construct($config = array())
    {
      //  echo "Hello";
        ...
        // echo "KEY Name".$key_name."API KEY".$apikey;
         //echo "<br/>";
       $this->_api_key = $apikey;
        $this->_api_name = $key_name;//die;
    }    
    ...
    */
    public function recipient_create($params = array()) {
        ...
        return $this->recipient_request('post', self::http_api_url.'recipients', $this->_api_key, $params);
    ...
    */
    ...
    protected function request($method, $url, $api_key, $params = array())
    {
        ...
        curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, false); //This line for ssl verifyer is need to insert
    ...
    protected function recipient_request($method, $url, $api_key, $data2 = array()) {
