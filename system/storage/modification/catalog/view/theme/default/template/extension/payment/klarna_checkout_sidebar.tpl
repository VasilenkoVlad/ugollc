    ...
    <div class="panel-heading">
        ...
        <div style="overflow: auto;">
        	...
        	<tr>
        	  ...
        	  <td class="text-center"><button type="button" onclick="kc.voucherRemove('<?php echo $credit['key']; ?>');" title="<?php echo $button_remove; ?>" class="btn-link"><i class="fa fa-times"></i></button></td>
        	</tr>
        	<?php } ?>
