      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="cart-form">
        <div class="table-responsive">
          <table class="table table-bordered">
            ...
            <tr>
              <td class="text-center"><?php if ($credit_image) { ?>
              ...
              <td class="text-left"><div class="input-group btn-block" style="max-width: 200px;">
                  ...
                  <span class="input-group-btn">
                  <button type="button" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger" onclick="credit.remove('<?php echo $credit['key']; ?>');"><i class="fa fa-times-circle"></i></button>
                  </span></div></td>
