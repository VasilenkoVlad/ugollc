	...
	public function getOrderVouchers($order_id) {
		...
		return $query->rows;
        	...
        	public function getOrderCredits($order_id) {
        		$query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "order_credit` WHERE order_id = '" . (int)$order_id . "'");
        
        		return $query->rows;
        	}

        	public function getOrderAddedCredits($order_id) {
                $query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "order_credit` WHERE order_id = '" . (int)$order_id . "' AND credit_id = 0");
