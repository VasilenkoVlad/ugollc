...
class VoiceController extends BaseController
{
     ...
     * Send a voice call
     *
     * @param Models\VoiceMessageCollection $voiceMessages VoiceMessageCollection model
    ...
    public function sendVoice(
        ...
        $response = Request::post($_queryUrl, $_headers, Request\Body::Json($voiceMessages));
     ...
     *
     * @param string $messageId  Your voice message id
     * @return string response from the API call
     * @throws APIException Thrown if API call fails
     */
     ...
     *
     * @param integer $dateFrom  (optional) Timestamp (from) used to show records by date.
     * @param integer $dateTo    (optional) Timestamp (to) used to show records by date
     * @return string response from the API call
     * @throws APIException Thrown if API call fails
     */
