...
class EmailToSmsController extends BaseController
{
     ...
     *
     * @param Models\EmailSMSAddress $emailSmsAddress EmailSMSAddress model
    ...
    public function createAllowedAddress(
        ...
        $response = Request::post($_queryUrl, $_headers, Request\Body::Json($emailSmsAddress));
