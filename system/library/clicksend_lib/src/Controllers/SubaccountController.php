...
class SubaccountController extends BaseController
{
     ...
     *
     * @param Models\Subaccount $subaccount Subaccount model
     * @return string response from the API call
     * @throws APIException Thrown if API call fails
     */
     ...
     *
     * @param integer $subaccountId  ID of subaccount to get
     * @return string response from the API call
     * @throws APIException Thrown if API call fails
     */
     ...
     * Delete a subaccount
     *
     * @param integer $subaccountId  ID of subaccount to delete
     * @return string response from the API call
     * @throws APIException Thrown if API call fails
     */
     ...
     *
     * @param integer $subaccountId  ID of subaccount to regenerate API key for
     * @return string response from the API call
     * @throws APIException Thrown if API call fails
     */
     ...
     * Update subaccount
     *
     * @param integer           $subaccountId  ID of subaccount to update
     * @param Models\Subaccount $subaccount    Subaccount model
     * @return string response from the API call
     * @throws APIException Thrown if API call fails
     */
