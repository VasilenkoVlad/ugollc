...
class TransferCreditController extends BaseController
{
     ...
     * Transfer Credit
     *
     * @param Models\ResellerAccountTransferCredit $resellerAccountTransferCredit ResellerAccountTransferCredit model
    ...
    public function transferCredit(
        ...
        if (!isset($resellerAccountTransferCredit)) {
        ...
        $response = Request::put($_queryUrl, $_headers, Request\Body::Json($resellerAccountTransferCredit));
