...
class SmsCampaignController extends BaseController
{
     ...
     * Create sms campaign
     *
     * @param Models\SmsCampaign $campaign SmsCampaign model
     ...
     * Update sms campaign
     *
     * @param integer            $smsCampaignId   ID of SMS campaign to update
     * @param Models\SmsCampaign $campaign        SmsCampaign model
     * @return string response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function updateSmsCampaign(
        ...
        //check that all required arguments are provided
        if (!isset($smsCampaignId, $campaign)) {
            throw new \InvalidArgumentException("One or more required arguments were NULL.");
        }
        ...
        //and invoke the API call request to fetch the response
        $response = Request::put($_queryUrl, $_headers, Request\Body::Json($campaign));
     ...
     * Cancel sms campaign
     *
     * @param integer $smsCampaignId   ID of SMS Campaign to cancel
     * @return string response from the API call
     * @throws APIException Thrown if API call fails
     */
     ...
     *
     * @param integer $smsCampaignId   ID of SMS campaign to retrieve
     * @return string response from the API call
     * @throws APIException Thrown if API call fails
     */
