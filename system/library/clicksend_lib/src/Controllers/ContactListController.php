...
class ContactListController extends BaseController
{
    ...
    public function createContactList(
        ...
        //and invoke the API call request to fetch the response
        $response = Request::post($_queryUrl, $_headers, $listName);
    ...
    public function updateContactList(
        ...
        //and invoke the API call request to fetch the response
        $response = Request::put($_queryUrl, $_headers, $listName);
     ...
     * @param Models\ContactListImport $file    ContactListImport model
     * @return string response from the API call
     * @throws APIException Thrown if API call fails
     */
