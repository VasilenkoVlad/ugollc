...
class UploadController extends BaseController
{
     ...
     *
     * @param Models\FileContent $content Base64-encoded file contents
     * @param string             $convert The product that this file will be used with e.g. 'fax', 'mms', 'csv' or
     *                                    'post'
     * @return string response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function uploadFile1(
        ...
        //and invoke the API call request to fetch the response
        $response = Request::post($_queryUrl, $_headers, Request\Body::Json($content));
