...
class MMSController extends BaseController
{
     ...
     *
     * @param Models\MmsMessageCollection $mmsMessages MmsMessageCollection model
    ...
    public function sendMMS(
        ...
        $response = Request::post($_queryUrl, $_headers, Request\Body::Json($mmsMessages));
