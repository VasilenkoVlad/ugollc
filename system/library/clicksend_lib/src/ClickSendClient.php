...
class ClickSendClient
{
     ...
     * @return Controllers\PostPostcardController The *Singleton* instance
     */
    public function getPostPostcard()
    {
        return Controllers\PostPostcardController::getInstance();
    }
    /**
     ...
     * @return Controllers\PostDirectMailController The *Singleton* instance
     */
    public function getPostDirectMail()
    {
        return Controllers\PostDirectMailController::getInstance();
    }
}
