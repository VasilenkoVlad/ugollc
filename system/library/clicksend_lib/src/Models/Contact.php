...
class Contact implements JsonSerializable
{
    ...
    public function __construct()
    {
        if (16 == func_num_args()) {
            ...
            $this->faxNumber         = func_get_arg(2);
            $this->firstName         = func_get_arg(3);
            $this->addressLine1      = func_get_arg(4);
            $this->addressLine2      = func_get_arg(5);
            $this->addressCity       = func_get_arg(6);
            $this->addressState      = func_get_arg(7);
            $this->addressPostalCode = func_get_arg(8);
            $this->addressCountry    = func_get_arg(9);
            $this->organizationName  = func_get_arg(10);
            $this->custom1           = func_get_arg(11);
